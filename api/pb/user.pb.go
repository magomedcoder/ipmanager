...
const file_user_proto_rawDesc = "" +
	...
	"\x06Logout\x12\x17.user.UserLogoutRequest\x1a\x18.user.UserLogoutResponseB*Z(github.com/magomedcoder/ipmanager/api/pbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.Login:input_type -> user.UserLoginRequest
	2, // 1: user.UserService.Logout:input_type -> user.UserLogoutRequest
	1, // 2: user.UserService.Login:output_type -> user.UserLoginResponse
	3, // 3: user.UserService.Logout:output_type -> user.UserLogoutResponse
